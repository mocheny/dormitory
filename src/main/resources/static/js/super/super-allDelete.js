...
/////////////////////////////////////////////////AllDormBuilding//////////////////////////////////////////////////////////
function adb_show_delete_model(dbid) {
    let modal = '<form class="form-horizontal" role="form" id="adb-delete-form" style="margin: 20px;">\n' +
        '        <div class="modal fade" id="adb-delete' + dbid + '" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"\n' +
        '             aria-hidden="true">\n' +
        '            <div class="modal-dialog">\n' +
        '                <div class="modal-content">\n' +
        '                    <div class="modal-header">\n' +
        ...
        '                    <div class="modal-footer">\n' +
        '                        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>\n' +
        '                        <button type="submit" class="btn btn-primary" id="adb-delete-submit">确定</button>\n' +
        '                    </div>\n' +
        '                </div>\n' +
        '            </div>\n' +
        '        </div>\n' +
    ...
    $('#adb-delete-submit').click(function () {
        $.ajax({
            type: "delete",
            url: "/deleteDb",
            xhrFields: {widthCredentials: true},
...
function adm_show_delete_model(mid) {
    let modal = '<form class="form-horizontal" role="form" id="adm-delete-form" style="margin: 20px;">\n' +
        '        <div class="modal fade" id="adm-delete' + mid + '" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"\n' +
        '             aria-hidden="true">\n' +
        '            <div class="modal-dialog">\n' +
        '                <div class="modal-content">\n' +
        '                    <div class="modal-header">\n' +
        ...
        '                    <div class="modal-footer">\n' +
        '                        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>\n' +
        '                        <button type="submit" class="btn btn-primary" id="adm-delete-submit">确定</button>\n' +
        '                    </div>\n' +
        '                </div>\n' +
        '            </div>\n' +
        '        </div>\n' +
    ...
    $('#adm-delete-submit').click(function () {
        $.ajax({
            type: "delete",
            url: "/deleteDMan",
            xhrFields: {widthCredentials: true},
