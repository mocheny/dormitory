...
public class DorDao {
    ...
    public List<Dormitory> queryAll() throws Exception {
        ...
        while (rs.next()) {
            ...
            dormitory.setLou(rs.getString("lou"));
            list.add(dormitory);
        }
        return list;
    }
    ...
    public List<Dormitory> queryOne(Integer i) throws Exception {
        ...
        while (rs.next()) {
            ...
            dormitory.setS1(rs.getString("s1"));
            dormitory.setS2(rs.getString("s2"));
            dormitory.setS3(rs.getString("s3"));
            dormitory.setS4(rs.getString("s4"));
            dormitory.setLou(rs.getString("lou"));
            list.add(dormitory);
        }
        return list;
